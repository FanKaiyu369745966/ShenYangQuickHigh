...
const unsigned char ProtocolStm32::g_head = 0xBA;
const unsigned char ProtocolStm32::g_tail = 0xBE;
const unsigned char ProtocolStm32::g_encode = 0xB0;

ProtocolStm32::ProtocolStm32() :ProtocolBase(ProtocolType::Protocol_Stm32)
{
}

ByteArray ProtocolStm32::Create(const ByteArray& data) const
{
	return Create(data.get(), data.size());
}

ByteArray ProtocolStm32::Create(const unsigned char* data, const int& maxSize) const
{
...
ByteArrayList ProtocolStm32::Process(ByteArray& data) const
{
...
ByteArray ProtocolStm32::Encoding(const unsigned char* data, const int& maxSize) const
{
	int len = 0, transf = 0;
...
ByteArray ProtocolStm32::Decoding(const unsigned char* data, const int& maxSize) const
{
	int len = 0, transf = 0;
