...
quint32 GraphicWorkStation::g_unWidth = 20;
quint32 GraphicWorkStation::g_unHeight = 20;
QImage GraphicWorkStation::g_icon("./res/image/station.png");

GraphicWorkStation::GraphicWorkStation(const quint32& unNo, const QString& name)
	: GraphicStation(unNo, name)
{
}

void GraphicWorkStation::SetIcon(const QString& path)
{
	g_icon.load(path);
...
void GraphicWorkStation::Draw(QPainter& painter)
{
