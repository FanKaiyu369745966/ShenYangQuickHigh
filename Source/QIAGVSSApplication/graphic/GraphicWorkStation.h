#ifndef GRAPHICWORKSTATION_H
#define GRAPHICWORKSTATION_H

#include "GraphicStation.h"

typedef class GraphicWorkStation IconWS;

class GraphicWorkStation :
	public GraphicStation
{
public:
	explicit GraphicWorkStation(const quint32& unNo, const QString& name = "");
protected:
