...
HistoryForm::HistoryForm(const QSqlDatabase& db, QWidget* parent) :
	QWidget(parent),
...
{
	m_model->setQuery(QString("SELECT * FROM AGVDB_TASK_HISTORY ORDER BY [task_finish] DESC,[task_id] DESC"));
